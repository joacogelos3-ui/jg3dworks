(() => {
  const translations = {
    en: {
      lang: "en", title: "JG3D Works | Automotive 3D Design", nav: ["Catalog", "Designs", "How it works", "FAQ"], order: "Request a design", menu: "MENU", mobileNav: ["Catalog", "Designs", "How it works", "Frequently asked questions"], whatsapp: "Contact us on WhatsApp",
    ...
    es: {
      lang: "es", title: "JG3D Works | Diseño 3D automotriz", nav: ["Catálogo", "Diseños", "Cómo funciona", "FAQ"], order: "Pedir diseño", menu: "MENÚ", mobileNav: ["Catálogo", "Diseños", "Cómo funciona", "Preguntas frecuentes"], whatsapp: "Consultar por WhatsApp",
    ...
    pt: {
      lang: "pt-BR", title: "JG3D Works | Design 3D automotivo", nav: ["Catálogo", "Projetos", "Como funciona", "FAQ"], order: "Solicitar projeto", menu: "MENU", mobileNav: ["Catálogo", "Projetos", "Como funciona", "Perguntas frequentes"], whatsapp: "Falar pelo WhatsApp",
  ...
  const replaceMobileWhatsappText = (node, value) => {
    if (!node) return;
